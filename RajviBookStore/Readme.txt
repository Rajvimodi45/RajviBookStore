...
---------
	...
	2:30 - create cover type repository
	2:40 - Change in UnitofWork.cs 
	2:55 - create migration and update database
	3:10 - migration successfully created
	3:25 - create controller and view for cover type
	4:50 - Faced some errors and try to resolve it
	6:30 - resolved errors and checked 
...
---------
    ...
    7:30 - create cover type Products
	7:45 - Change in UnitofWork.cs 
	7:55 - create migration and update database
	8:20 -  migration successfully created
	8:30 - create controller and view for cover type
	9:15 - Faced some errors and try to resolve it
	10:00 - resolved errors and checked
